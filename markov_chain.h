...
{
// this is the word with a list to the frequency list
    void *data; //the word
    NextNodeCounter *counter_list; //pointer to pointers -dynamic
    int counter_size;
    int sum_freq;
}MarkovNode;
/***************************/
...
MarkovChain * create_markov_chain(print_func print, comp_func compare,
                                  ...
                                  is_last_f);
void print_counter_list(MarkovNode *markov_node, print_func print_func1);
